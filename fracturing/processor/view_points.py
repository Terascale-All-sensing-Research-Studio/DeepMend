...
def view_points(
    ...
    if f_points is None:
        break_idx = [p for p in os.path.splitext(f_in)[0].split("_") if p.isnumeric()][0]
        ...
        if "xyz" in data:
            ...
            for sp in sample_paths:
                cur_break_idx = [p for p in os.path.splitext(sp)[0].split("_") if p.isnumeric()][0]
    ...
    if slice:
        ...
        # Get colors
        color = colorize_values(values, cmap=None, min_max=None)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="If passed, will display a plot of 4x4 slices.",
    )
    parser.add_argument(
        "--key",
        default=None,
