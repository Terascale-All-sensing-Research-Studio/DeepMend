...
class get_model(nn.Module):
    def __init__(self, part_num=50, class_num=16, normal_channel=True):
        ...
        self.convs1 = torch.nn.Conv1d(
            64 + 128 + 128 + 512 + 2048 + 2048 + self.class_num, 256, 1
        )
    ...
    def forward(self, point_cloud, label):
        ...
        expand = out_max.view(-1, 2048+self.class_num, 1).repeat(1, 1, N)
